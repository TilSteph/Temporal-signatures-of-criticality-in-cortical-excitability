...
load([savepath_MANUSCRIPT 'DFA_exponents_with_permutations_and_CCA_averages_MANUSCRIPT.mat']); % needed for time_vec
...
load([savepath_MANUSCRIPT 'subj_27/CCA_subj27_notask_30to200Hz_nonotch_stdzd_CP4.mat']) % single-subject CCA data
x_lim = [-20 100];
...
export_fig([figure_path 'Subj27_CCA_tangential_singletrials.eps'], '-eps', '-transparent', h)

% Panel B
% Plot SEP amplitude time courses
load([savepath_MANUSCRIPT 'subj_27/DFA_subj27_notask_30to200Hz_nonotch_stdzd.mat']) % load single subject data containing DFA and amplitude information
...
%sz = 10;
h4 = figure; hold on
plot(time_vec, DFA_all_lats)
xlim([-20 100])

export_fig([savepath_figures 'Fig3d_DFA_time_course_subj27.eps'], '-eps', '-transparent', h4)
